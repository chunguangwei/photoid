...
| 处理 `edit_page` | 流水线步骤进度（preparing→…→compressing 六项，配「扫描揭色」动效：照片从灰度逐行变彩色，直观表达处理进度）；高精修/普通档切换；五色底色**秒切**；**美颜 / 清晰度双滑杆**；手势缩放平移的交互裁剪；原图/效果对比切换 |
