...
| 页面 | 内容 |
|---|---|
| 启动页 `splash_page` | 矢量绘制的品牌吉祥物——举着手机自拍的圆润机器人，会眨眼、呼吸浮动；6 秒倒计时可跳过，底部预留广告位槽。这段空闲期同时预热抠图模型，缩短首张照片的等待 |
